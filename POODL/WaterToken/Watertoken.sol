...
// Defining the WaterToken contract, which inherits from the ERC20 standard contract
contract WaterToken is ERC20 {
    ...
    // It initializes the ERC20 token with the name "Water Project" and symbol "Water"
    constructor() ERC20("Water Project", "Water") {
