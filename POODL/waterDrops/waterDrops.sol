...
contract  WaterDrops is Context, IERC20, Ownable {
    ...
    string  private constant NAME = " WATER DROPS";
    string  private  constant SYMBOL = "DROPS";
    ...
    //sell tax percentage
    uint256 public sellReflectionTax = 49;
    ...
    */
    ...
    /**
    * @dev update the buy and sell taxes.
    * Only the contract owner can call this function.
    * 
    * @param buyTax and sellTax parameters
    */
    function updateTaxes(uint256 buyTax, uint256 sellTax) external  onlyOwner {
        buyReflectionTax = buyTax;
        sellReflectionTax = sellTax;
    }
