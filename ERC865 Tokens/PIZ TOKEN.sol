...
// ----------------------------------------------------------------------------
// 'PIZ' Token contract with following features
...
// Decimals    : 18
//
// Copyright (c) 2019 PIZ TOKEN Inc. The MIT Licence.
...
//****************************************************************************//
//---------------------  PIZ TOKEN MAIN CODE STARTS HERE ---------------------//
//****************************************************************************//
    
contract PIZTOKEN is owned, TokenERC20 {
    
    
    /***************************************/
    /* Custom Code for the ERC20 PIZ TOKEN */
    /***************************************/

    /* Public variables of the token */
    string private tokenName = "PIZ TOKEN";
    string private tokenSymbol = "PIZ";
    uint256 private initialSupply = 8000000000;  //8 Billion
    ...
    /****************************************/
    /* Custom Code for the ERC865 PIZ TOKEN */
    /****************************************/
