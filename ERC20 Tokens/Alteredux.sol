...
=== 'Alteredux' Token contract with following features ===
    => ERC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2020 onwards Alteredux Inc. ( https://Alteredux.com )
...
contract Alteredux is owned {
    ...
    string constant private _name = "Alteredux";
    string constant private _symbol = "AEX";
