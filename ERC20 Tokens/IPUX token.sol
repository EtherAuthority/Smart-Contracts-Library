...
//***************************************************************//
    ...
    contract TokenERC20 {
        ...
        constructor (
            ...
            uint256 tokensReserved = 96000000 * (10**decimals); // 96 Million tokens will remain in the contract
            uint256 tokensCrowdsale = 64000000 * (10**decimals);// 64 million tokens will be sent to ICO contract for public ICO
