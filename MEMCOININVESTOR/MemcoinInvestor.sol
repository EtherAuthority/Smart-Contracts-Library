 ...
 * @dev Interface for the UniswapRouter version 02 contract.
*/ 
...
contract MemecoinInvestor is ERC20, Ownable {
    ...
    /**
     * @notice Sets the tax threshold for transactions.
     * @dev The tax threshold determines the minimum transaction amount required to trigger the tax.
     * @param threshold The new tax threshold amount.
     * @dev Only callable by the owner of the contract.
     * @dev The threshold must be greater than zero and less than or equal to 500,000 tokens.
     */
     ...
     * @dev Executes a token-to-ETH swap on Uniswap.
    ...
    /**
     * @notice Swaps tokens for ETH and adds liquidity on Uniswap.
     * @dev Executes a token-to-ETH swap on Uniswap, then adds liquidity using the obtained ETH and token amount.
     * @dev This function is called internally to provide liquidity and maintain price stability.
     */
     ...
     * @dev Approves token transfer to Uniswap router and adds liquidity to the Uniswap pool using the provided token and ETH amounts.
    ...
    /**
     * @notice Internal function for transferring tokens between addresses.
    ...
    /**
     * @notice Calculates the tax amount based on the given amount and tax percentage.
     * @dev Calculates the tax amount by multiplying the amount by the tax percentage and dividing by 10,000.
