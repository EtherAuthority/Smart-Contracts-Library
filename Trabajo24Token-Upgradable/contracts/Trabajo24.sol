...
contract Trabajo24Token is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, OwnableUpgradeable,UUPSUpgradeable {
    ...
    // * @param mutising  in  Owable_init function.
    ...
    // */
    function initialize(address mutising) public initializer {
        __Ownable_init(mutising);
        ...
        maxTransactionAmount = 2000000 * 10 ** decimals();
        // Mint initial supply
        _mint(mutising,_totalSupply);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
        0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff //polygon router address
        ); 
    ...
    /**
     * @dev Authorizes the contract upgrade to a new implementation.
